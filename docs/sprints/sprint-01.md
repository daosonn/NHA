...
- [x] 1.1.7 Khôi phục mật khẩu (quên mật khẩu — `PasswordResetToken`; added 2026-08-14, see `database.md`) — API done 2026-08-18 (chi tiết: `api-contract.md`); UI mobile đã build, chưa nối
