...
| ---------------------------------- | -------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Authentication (register/login)    | IN       | Spec #12. Incl. join-by-invite-code and linking account to existing Member. Social login (customer requirement 2026-08-17): **Google + Facebook scheduled in Sprint 1 (1.1.8–1.1.9); LINE deferred pending email-permission application (re-confirm with customer); X phase 2; Instagram infeasible** (see `02-backend/architecture.md`) |
