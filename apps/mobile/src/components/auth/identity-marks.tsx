 ...
 *
 * Facebook went on 2026-09-01 (owner's call). Only the button went: the
 * server kept its route, so an account already linked through Facebook
 * would still sign in. None is — every OAuth account on record is Google.
 */
