...
export type SceneEffect = 'zoom_in' | 'zoom_out' | 'pan_lr' | 'pan_rl' | 'pan_ud' | 'pan_du' | 'static';
...
export type IntroTemplateId = 'album' | 'cinema' | 'film' | 'letter' | 'seasonal' | 'polaroid' | 'none';
// 'memories' là mặc định: cut đúng nhịp + Ken Burns cực nhẹ + counter-slide/bloom/whip
export type EffectProfile = 'off' | 'soft' | 'cinematic' | 'vintage' | 'memories';
export type MusicThemeId = 'birthday' | 'wafu' | 'family' | 'nostalgia' | 'gentle';
